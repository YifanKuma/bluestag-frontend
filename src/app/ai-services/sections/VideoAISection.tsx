...
export default function VideoAISection() {
    return (
        <section className="relative z-10">
            {/* ✨ violet/indigo backdrops from the first design */}
            <div
            ...
            {/* Header — keep the original phrasing */}
            <motion.header
                variants={fadeUp}
                initial="hidden"
                whileInView="show"
            ...
            {/* Feature grid (keep from first design) */}
            <motion.div
                variants={stagger}
                initial="hidden"
                whileInView="show"
            ...
            {/* NEW: Use‑case grid (from second version, added below features) */}
            <motion.div
                variants={stagger}
                initial="hidden"
                whileInView="show"
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                        ...
                        <div key={i}
                            ...
                            <button
                                className="absolute inset-0 m-auto flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-black/50 backdrop-blur transition group-hover:scale-105"
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-white/70">{v.ratio} • {v.len}</p>
                                </div>
                                <span
                                    className="rounded-md border border-white/10 bg-white/10 px-2 py-0.5 text-[10px]">Preview</span>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <ol className="mt-4 grid gap-4 md:grid-cols-3">
                    {[
                        ...
                        <li key={s.step} className="relative rounded-xl border border-white/10 bg-black/20 p-4">
                            <div
                                className="absolute -left-3 -top-3 flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 bg-white/10 text-sm font-semibold">{s.step}</div>
            ...
            >
                <div
                    ...
                    <div className="relative">
                        <h5 className="text-xl font-semibold">Ready to scale your video output?</h5>
                        <p className="mt-1 text-white/70">Book a 10‑minute demo to see auto‑editing, captions, and
                            publishing in action.</p>
