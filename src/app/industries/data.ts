...
export const INDUSTRIES: Industry[] = [
    {
        ...
        title: "Real Estate",
        summary:
            "Qualify buyers and tenants, schedule inspections, and follow up automatically.",
        bullets: [
        ...
        demo: [
            ...
            {
                actor: "Agent",
                text: "Locked in! I’ve sent a calendar invite and directions. See you then.",
            },
        ],
    ...
    },
    {
        ...
        summary:
            "Handle order questions, returns, and delivery updates without wait times.",
        bullets: [
        ...
        demo: [
            ...
            {
                actor: "Agent",
                text: "Done. Delivery updated to 5–7pm window. You’ll receive a confirmation SMS.",
            },
        ],
    ...
    },
    {
        ...
        summary:
            "Automate payment reminders and offer secure pay-by-link or IVR collection.",
        bullets: [
    ...
    },
    {
        ...
        title: "Logistics",
        summary:
            "Confirm deliveries, reschedule pickups, and notify customers on time.",
        bullets: [
        ...
        demo: [
            ...
            {
                actor: "Agent",
                text: "Rescheduled to Friday 9–11am. You’ll get a reminder 1 hour before.",
            },
        ],
    ...
    },
    {
        ...
        summary:
            "Resolve FAQs instantly and escalate complex issues with full transcripts.",
        bullets: [
        ...
        demo: [
            ...
            {
                actor: "Agent",
                text: "I can help. Would you like to pause or apply a courtesy credit?",
            },
    ...
    },
    {
        ...
        title: "Healthcare",
        summary:
            "Reduce no-shows with reminders and collect post-visit feedback with empathy.",
        bullets: [
    ...
    },
    {
        ...
        summary:
            "Automate admissions triage, interview scheduling, fee reminders, and student support.",
        bullets: [
        ...
        demo: [
            ...
            {
                actor: "Agent",
                text: "Booked for 2:30pm Thu with Admissions. I’ve sent a calendar invite and checklist.",
            },
        ],
