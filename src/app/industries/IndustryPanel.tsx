...
export default function IndustryPanel({industry}: { industry: Industry }) {
    ...
    return (
        <motion.div
            ...
            className="relative overflow-hidden group bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-xl shadow-lg"
        >
            {/* glow */}
            <motion.div
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                    <industry.icon className="w-10 h-10 text-sky-400 drop-shadow-lg"/>
                    ...
                    {open && (
                        ...
                        >
                            <div
                                ...
                                <p><span className="font-semibold text-gray-300">How it works:</span> ASR → NLU → Policy
                                    Engine → Tool Calls → TTS.</p>
                                <p><span className="font-semibold text-gray-300">Integrations:</span> Calendars, CRMs,
                                    SMS/email, payments, and more.</p>
