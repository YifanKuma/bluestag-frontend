...
import { navbarData } from "@/lib/navbar-prop";
...
interface NavLinkItem {
    id: number;
    label: string;
    href: string; // can include #section
}
...
export default function Navbar() {
    ...
    const { logo, nav_link = [], cta_label, cta_href, enable_scroll_style } =
        typedNavbarData;
                            ...
                            return (
                                <Link
                                    ...
                                    className={`
                                        relative px-1 pb-1
                                        transition
                                        ${active ? "text-cyan-300 font-semibold" : "text-white/90 hover:text-cyan-300"}
                                    `}
                                >
                                    {item.label}
                                    {active && <Underline />}
